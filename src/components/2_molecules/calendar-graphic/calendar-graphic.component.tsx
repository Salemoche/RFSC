...
function CalendarGraphicComponent() {
    ...
    const { eventPositions, calendarHeight } = useBaseState().state.calendar
    ...
    const handleClick = (e) => {
        ...
        if (e.target.id.includes('event') || e.target.parentNode.id.includes('event')) {
            let clickTarget = e.target.id.includes('event') ? e.target : e.target.parentNode;
            type = 'event';
            id = clickTarget.id;
            ...
            if (eventId) {
                ...
                setCurrentDetail({ showEventDetail: true, showTattooDetail: false, showRadioDetail: false }, eventId);
            } else {
                console.log('no id');
                history.push('/space');
            }
            ...
            type = 'week';
            id = e.target.getAttribute('data-week');
            
            const weekPositions = eventPositions.filter(position => {
                return position.week === +id
            }).slice(0).reverse()[0]?.position
            let scrollPosition = calendarHeight - weekPositions
            ...
            let clickTarget = e.target;
            type = 'day';
            id = e.target.getAttribute('data-day');
            
            let scrollPosition = calendarHeight - eventPositions.filter(position => {
                return position.day === +id
            })[0]?.position
    ...
    const setCurrentDetail = (showDetails = { showEventDetail: false, showTattooDetail: false, showRadioDetail: false }, id) => {
    ...
    return (
        <CalendarGraphic className="rfsc-calendar__graphic" styles={styles} currentDetail={currentDetail} filters={filters} rotations={rotations} hasScrolled={hasScrolled}>
...
<g id="Layer_1">
	...
	<g id="Tage">
		<path id="m7-w1-d2-day" data-day="2" onClick={ handleClick } className="st0" d="M772.1,102.5V90h-4.8v-2.2h12.2V90h-4.8v12.5H772.1z M790.6,100.3v2.2h-10.3
		...
		<path id="m7-w1-d3-day" data-day="3" onClick={ handleClick } className="st0" d="M707.2,133.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H707.2z M726,128.8c0,3-2.2,4.6-5.2,4.6
		...
		<path id="m7-w1-d4-day" data-day="4" onClick={ handleClick } className="st0" d="M662.6,163.7v-12.5h-4.8V149H670v2.2h-4.8v12.5H662.6z M680,158.5v2.1h-1.9v3h-2.4v-3h-6.4
		...
		<path id="m7-w1-d5-day" data-day="5" onClick={ handleClick } className="st0" d="M623.7,194.3v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H623.7z M642.4,189.5c0,2.8-1.8,5-5.3,5
		...
		<path id="m7-w2-d6-day" data-day="6" onClick={ handleClick } className="st0" d="M593,224.9v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H593z M611.8,220.1c0,2.4-1.4,5-5.2,5
		...
		<path id="m7-w2-d7-day" data-day="7" onClick={ handleClick } className="st0" d="M570.4,255.5V243h-4.8v-2.2h12.2v2.2H573v12.5H570.4z M578.7,240.7h9.7v2.2
			c-3.2,3-5.1,7.7-5.3,12.6h-2.7c0.3-4.6,2-9.2,5.3-12.6h-7.1L578.7,240.7L578.7,240.7z"/>
		<path id="m7-w2-d8-day" data-day="8" onClick={ handleClick } className="st0" d="M546.1,286.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H546.1z M565.2,281.8c0,3-2.3,4.5-5.3,4.5
		...
		<path id="m7-w2-d9-day" data-day="9" onClick={ handleClick } className="st0" d="M528.3,316.7v-12.5h-4.8V302h12.2v2.2h-4.8v12.5H528.3z M547.3,308.9c0,4.7-1.4,8-5.6,8
		...
		<path id="m7-w2-d10-day" data-day="10" onClick={ handleClick } className="st0" d="M504.6,347.3v-12.5h-4.8v-2.2H512v2.2h-4.8v12.5H504.6z M518.9,332.5v14.8h-2.5v-10.7
		...
		<path id="m7-w2-d11-day" data-day="11" onClick={ handleClick } className="st0" d="M495.7,377.8v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H495.7z M509.9,363.1v14.8h-2.5v-10.7
		...
		<path id="m7-w2-d12-day" data-day="12" onClick={ handleClick } className="st0" d="M482.2,408.4v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H482.2z M496.4,393.7v14.8h-2.5v-10.7
		...
		<path id="m7-w2-d13-day" data-day="13" onClick={ handleClick } className="st0" d="M474.6,439v-12.5h-4.8v-2.2H482v2.2h-4.8V439H474.6z M488.8,424.3V439h-2.5v-10.7
		...
		<path id="m7-w3-d14-day" data-day="14" onClick={ handleClick } className="st0" d="M468.5,469.6v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H468.5z M482.7,454.9v14.8h-2.5V459
		...
		<path id="m7-w3-d15-day" data-day="15" onClick={ handleClick } className="st0" d="M465,500.2v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H465z M479.2,485.5v14.8h-2.5v-10.7
		...
		<path id="m7-w3-d16-day" data-day="16" onClick={ handleClick } className="st0" d="M462.7,530.8v-12.5h-4.8V516h12.2v2.2h-4.8v12.5L462.7,530.8L462.7,530.8z M476.9,516
		...
		<path id="m7-w3-d17-day" data-day="17" onClick={ handleClick } className="st0" d="M464.4,561.4v-12.5h-4.8v-2.2h12.2v2.2H467v12.5H464.4z M478.7,546.6v14.8h-2.5v-10.7
		...
		<path id="m7-w3-d18-day" data-day="18" onClick={ handleClick } className="st0" d="M464.5,592v-12.5h-4.8v-2.2h12.2v2.2h-4.8V592H464.5z M478.7,577.2V592h-2.5v-10.7
		...
		<path id="m7-w3-d19-day" data-day="19" onClick={ handleClick } className="st0" d="M468,622.6V610h-4.8v-2.2h12.2v2.2h-4.8v12.5L468,622.6L468,622.6z M482.2,607.8v14.8
		...
		<path id="m7-w3-d20-day" data-day="20" onClick={ handleClick } className="st0" d="M469.7,653.2v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H469.7z M488.2,651v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d21-day" data-day="21" onClick={ handleClick } className="st0" d="M482,683.7v-12.5h-4.8V669h12.2v2.2h-4.8v12.5H482z M500.5,681.6v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d22-day" data-day="22" onClick={ handleClick } className="st0" d="M488,714.3v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H488z M506.5,712.1v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d23-day" data-day="23" onClick={ handleClick } className="st0" d="M500.6,744.9v-12.5h-4.8v-2.2H508v2.2h-4.8v12.5H500.6z M519.1,742.7v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d24-day" data-day="24" onClick={ handleClick } className="st0" d="M515.9,775.5V763h-4.8v-2.2h12.2v2.2h-4.8v12.5H515.9z M534.4,773.3v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d25-day" data-day="25" onClick={ handleClick } className="st0" d="M534.1,806.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H534.1z M552.6,803.9v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d26-day" data-day="26" onClick={ handleClick } className="st0" d="M555.5,836.7v-12.5h-4.8V822H563v2.2h-4.8v12.5H555.5z M574.1,834.5v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w4-d27-day" data-day="27" onClick={ handleClick } className="st0" d="M582.5,867.3v-12.5h-4.8v-2.2H590v2.2h-4.8v12.5H582.5z M601,865.1v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w5-d28-day" data-day="28" onClick={ handleClick } className="st0" d="M611.9,897.9v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H611.9z M630.4,895.7v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w5-d29-day" data-day="29" onClick={ handleClick } className="st0" d="M649.1,928.5V916h-4.8v-2.2h12.2v2.2h-4.8v12.5H649.1z M667.6,926.3v2.2h-10.3
			c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
		...
		<path id="m7-w5-d30-day" data-day="30" onClick={ handleClick } className="st0" d="M694.9,959.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H694.9z M713.7,954.8
		...
		<path id="m7-w5-d31-day" data-day="31" onClick={ handleClick } className="st0" d="M761.9,989.6v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H761.9z M780.7,985.3
			c0,3-2.2,4.6-5.2,4.6c-3.4,0-5.1-2-5.2-4.8l2.6-0.4c0,1.9,0.9,3.1,2.6,3.1c1.6,0,2.6-0.8,2.6-2.4c0-1.7-1.3-2.3-2.5-2.3h-1.4v-2.2
			h1.1c1,0,2.2-0.5,2.2-2c0-1.3-0.7-2.1-2.1-2.1c-1.9,0-2.3,1.6-2.3,2.8l-2.7-0.4c0.1-2.8,2.1-4.5,5-4.5c2.6,0,4.7,1.4,4.7,4.1
		...
		<path id="m8-w5-d1-day" data-day="1" onClick={ handleClick } className="st0" d="M876.6,1020.2v-12.5h-4.8v-2.2H884v2.2h-4.8v12.5H876.6z M890.9,1005.5v14.8h-2.5v-10.7
			c-0.7,0.7-1.8,0.9-3,0.9c-0.2,0-0.4,0-0.6,0v-2.2c2.4,0,3.7-0.8,4-2.7L890.9,1005.5L890.9,1005.5z"/>
		<path id="m7-w1-d1-day" data-day="1" onClick={ handleClick } className="st0" d="M876.7,71.9V59.4h-4.8v-2.2h12.2v2.2h-4.8v12.5H876.7z M890.9,57.1v14.8h-2.5V61.2
    ...
    <g id="Tage">
        ...
        <text id="m7-w1-d1-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${595.3564 + textDisplacer.left } 71.8219)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="409.8" y="87.7" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w1-d2-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${531.1605 + textDisplacer.left } 102.4361)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="362.8" y="118.4" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w1-d3-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${484.1981 + textDisplacer.left } 133.1361)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="329.4" y="148.9" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w1-d4-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${450.7979 + textDisplacer.left } 163.5654)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="251.1" y="240.7" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d7-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${372.4602 + textDisplacer.left } 255.4041)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="227.1" y="271.2" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d8-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${348.4495 + textDisplacer.left } 285.9105)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="211.1" y="301.9" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d9-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${332.5005 + textDisplacer.left } 316.5961)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="196.8" y="332.5" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d10-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${318.1196 + textDisplacer.left } 347.2019)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="187.8" y="363.1" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d11-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${309.1953 + textDisplacer.left } 377.751)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="165.7" y="454.8" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d14-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${287.0198 + textDisplacer.left } 469.4921)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="160.6" y="485.4" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d15-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${281.9244 + textDisplacer.left } 500.1016)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="158.3" y="516" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d16-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${279.6149 + textDisplacer.left } 530.6981)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="158.4" y="546.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d17-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${279.7241 + textDisplacer.left } 561.2972)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="161.5" y="577.3" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d18-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${282.8087 + textDisplacer.left } 591.9966)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="173.3" y="669" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d21-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${294.7046 + textDisplacer.left } 683.6674)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="183.9" y="699.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d22-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${305.2268 + textDisplacer.left } 714.3019)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="196.8" y="729.5" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d23-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${318.1798 + textDisplacer.left } 744.1951)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="213" y="760.8" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d24-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${334.405 + textDisplacer.left } 775.4863)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="233.9" y="791.4" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d25-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${355.2292 + textDisplacer.left } 806.0963)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="296.6" y="883.1" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d28-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${417.9083 + textDisplacer.left } 897.8162)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="326.5" y="913.7" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d29-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${447.8741 + textDisplacer.left } 928.416)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="363" y="944.3" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d30-event-1" onClick={ handleClick } transform={`matrix(1 0 0 1 ${484.3356 + textDisplacer.left } 958.9915)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        ...
        <text id="m7-w1-d2-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1252.7242 + textDisplacer.right } 102.4317)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1301" y="118.3" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w1-d3-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1300.9912 + textDisplacer.right } 132.9902)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1337.8" y="148.9" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w1-d4-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1337.8333 + textDisplacer.right } 163.5974)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1418.7" y="240.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d7-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1418.7083 + textDisplacer.right } 255.3022)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1440" y="271.3" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d8-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1440.0204 + textDisplacer.right } 285.9643)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1455.9" y="301.8" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d9-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1455.9 + textDisplacer.right } 316.5009)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1464.3" y="332.4" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d10-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1464.3292 + textDisplacer.right } 347.1237)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1477.9" y="363" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w2-d11-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1477.9467 + textDisplacer.right } 377.6995)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1502.6" y="454.8" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d14-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1502.6464 + textDisplacer.right } 469.5027)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1508" y="485.4" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d15-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1507.9623 + textDisplacer.right } 500.1107)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1510.2" y="516" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d16-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1510.1562 + textDisplacer.right } 530.691)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1509.3" y="546.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d17-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1509.2738 + textDisplacer.right } 561.3027)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1507" y="577.2" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w3-d18-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1506.9536 + textDisplacer.right } 591.8961)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1495.6" y="669" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d21-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1495.6423 + textDisplacer.right } 683.7068)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1485.1" y="699.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d22-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1485.0609 + textDisplacer.right } 714.2977)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1472.4" y="730.2" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d23-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1472.3601 + textDisplacer.right } 744.9019)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1457.2" y="760.7" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d24-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1457.2482 + textDisplacer.right } 775.3928)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1440.4" y="791.3" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w4-d25-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1440.3759 + textDisplacer.right } 805.9915)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1366.8" y="883.1" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d28-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1366.7568 + textDisplacer.right } 897.8123)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1337.5" y="913.6" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d29-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1337.536 + textDisplacer.right } 928.2952)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
        <rect x="1301.5" y="944.2" className="st8" width="251.7" height="15.7"/>
        <text id="m7-w5-d30-event-2" onClick={ handleClick } transform={`matrix(1 0 0 1 ${1301.4639 + textDisplacer.right } 958.8983)`}><tspan x="0" y="0" className="st1 st9">VERANSTALTUNGS-SLOT</tspan></text>
	...
	<g id="Wochen">
		<path id="m7-w2-d7-week" data-week="2" onClick={ handleClick } className="st0" d="M1333.1,255.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
		...
		<path id="m7-w2-d8-week" data-week="2" onClick={ handleClick } className="st0" d="M1354.9,286.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w2-d9-week" data-week="2" onClick={ handleClick } className="st0" d="M1373.6,316.7l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w2-d10-week" data-week="2" onClick={ handleClick } className="st0" d="M1388.5,347.3l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w2-d11-week" data-week="2" onClick={ handleClick } className="st0" d="M1400.8,377.8l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w3-d14-week" data-week="3" onClick={ handleClick } className="st0" d="M1424.3,469.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w3-d15-week" data-week="3" onClick={ handleClick } className="st0" d="M1427.9,500.2l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w3-d16-week" data-week="3" onClick={ handleClick } className="st0" d="M1428.4,530.8l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w3-d17-week" data-week="3" onClick={ handleClick } className="st0" d="M1429.5,561.4l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w3-d18-week" data-week="3" onClick={ handleClick } className="st0" d="M1427.8,592l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0c0.3-1.2,0.6-2.5,0.9-3.7
		...
		<path id="m7-w4-d21-week" data-week="4" onClick={ handleClick } className="st0" d="M1410.7,683.7l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w4-d22-week" data-week="4" onClick={ handleClick } className="st0" d="M1401.3,714.3l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w4-d23-week" data-week="4" onClick={ handleClick } className="st0" d="M1388.4,744.9l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w4-d24-week" data-week="4" onClick={ handleClick } className="st0" d="M1373.3,775.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w4-d25-week" data-week="4" onClick={ handleClick } className="st0" d="M1354.2,806.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w5-d28-week" data-week="5" onClick={ handleClick } className="st0" d="M1277.4,897.9l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w5-d29-week" data-week="5" onClick={ handleClick } className="st0" d="M1239.9,928.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w5-d30-week" data-week="5" onClick={ handleClick } className="st0" d="M1192.8,959.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w5-d31-week" data-week="5" onClick={ handleClick } className="st0" d="M1125.9,989.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w1-d1-week" data-week="1" onClick={ handleClick } className="st0" d="M1026.8,72l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0c0.3-1.2,0.6-2.5,0.9-3.7
			l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
		...
		<path id="m7-w1-d2-week" data-week="1" onClick={ handleClick } className="st0" d="M1129.1,102.4l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m7-w1-d3-week" data-week="1" onClick={ handleClick } className="st0" d="M1194.4,133l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0c0.3-1.2,0.6-2.5,0.9-3.7
		...
		<path id="m7-w1-d4-week" data-week="1" onClick={ handleClick } className="st0" d="M1240.1,163.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
		...
		<path id="m8-w5-d1-week" data-week="5" onClick={ handleClick } className="st0" d="M1028.6,1020.2l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7l0,0
			c0.3-1.2,0.6-2.5,0.9-3.7l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7l0,0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8
...
<g id="Hilfslinien" className="st14">
        ...
        {/* <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            ...
            <g onClick={handleClick} id="Tage">
                <path onClick={handleClick} id="m7-w1-d2-day" data-day="2" onClick={ handleClick } className="st0" d="M772.1,102.5V90h-4.8v-2.2h12.2V90h-4.8v12.5H772.1z M790.6,100.3v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H790.6z"/>
                <path onClick={handleClick} id="m7-w1-d3-day" data-day="3" onClick={ handleClick } className="st0" d="M707.2,133.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H707.2z M726,128.8c0,3-2.2,4.6-5.2,4.6
                    c-3.4,0-5.1-2-5.2-4.8l2.6-0.4c0,1.9,0.9,3.1,2.6,3.1c1.6,0,2.6-0.8,2.6-2.4c0-1.7-1.3-2.3-2.5-2.3h-1.4v-2.2h1.1
                    c1,0,2.2-0.5,2.2-2c0-1.3-0.7-2.1-2.1-2.1c-1.9,0-2.3,1.6-2.3,2.8l-2.7-0.4c0.1-2.8,2.1-4.5,5-4.5c2.6,0,4.7,1.4,4.7,4.1
                    c0,1.3-0.7,2.4-1.9,3C725.2,125.7,726,127.2,726,128.8z"/>
                <path onClick={handleClick} id="m7-w1-d4-day" data-day="4" onClick={ handleClick } className="st0" d="M662.6,163.7v-12.5h-4.8V149h12.2v2.2h-4.8v12.5H662.6z M680,158.5v2.1h-1.9v3h-2.4v-3h-6.4
                ...
                <path onClick={handleClick} id="m7-w1-d5-day" data-day="5" onClick={ handleClick } className="st0" d="M623.7,194.3v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H623.7z M642.4,189.5c0,2.8-1.8,5-5.3,5
                    c-2.9,0-5-1.7-5-4.7l2.5-0.4c0,1.9,1,3,2.5,3c1.8,0,2.7-1.1,2.7-3c0-1.8-1.1-2.7-2.7-2.7c-1.1,0-1.9,0.4-2.4,1.1l-2.3-0.4l1.1-8
                    h8.1v2.2h-6l-0.5,3.8c0.6-0.6,1.5-1,2.6-1C640.1,184.6,642.4,186.1,642.4,189.5z"/>
                <path onClick={handleClick} id="m7-w2-d6-day" data-day="6" onClick={ handleClick } className="st0" d="M593,224.9v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H593z M611.8,220.1c0,2.4-1.4,5-5.2,5
                    c-4.4,0-5.4-3.8-5.4-7.2c0-4.8,1.5-8,5.7-8c2.8,0,4.2,1.7,4.5,3.9l-2.5,0.4c-0.1-1.1-0.6-2.2-2.1-2.2c-2.5,0-3.1,2.6-3.1,5.3
                    c0.7-1.3,2-2,3.5-2C610,215.3,611.8,217.3,611.8,220.1z M609.3,220.1c0-1.7-0.8-2.7-2.5-2.7c-1.7,0-2.6,1.2-2.6,2.8
                    c0,1.4,0.7,2.8,2.5,2.8C608.5,223,609.3,222.1,609.3,220.1z"/>
                <path onClick={handleClick} id="m7-w2-d7-day" data-day="7" onClick={ handleClick } className="st0" d="M570.4,255.5V243h-4.8v-2.2h12.2v2.2H573v12.5H570.4z M578.7,240.7h9.7v2.2
                    c-3.2,3-5.1,7.7-5.3,12.6h-2.7c0.3-4.6,2-9.2,5.3-12.6h-7.1V240.7z"/>
                <path onClick={handleClick} id="m7-w2-d8-day" data-day="8" onClick={ handleClick } className="st0" d="M546.1,286.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H546.1z M565.2,281.8c0,3-2.3,4.5-5.3,4.5
                    c-3.3,0-5.3-1.7-5.3-4.5c0-2,0.8-3.2,2.5-3.8c-1.2-0.5-2-1.5-2-3.1c0-2.1,1.4-3.9,4.8-3.9c3.3,0,4.7,1.8,4.7,3.9
                    c0,1.5-0.8,2.5-2,3.1C564.4,278.5,565.2,279.8,565.2,281.8z M562.6,281.7c0-1.5-1-2.5-2.7-2.5c-1.6,0-2.7,0.9-2.7,2.5
                ...
                <path onClick={handleClick} id="m7-w2-d9-day" data-day="9" onClick={ handleClick } className="st0" d="M528.3,316.7v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H528.3z M547.3,308.9c0,4.7-1.4,8-5.6,8
                    c-2.8,0-4.3-1.7-4.6-4l2.4-0.4c0.1,1.2,0.7,2.3,2.2,2.3c2,0,3-1.8,3-5.2c-0.7,1.2-1.9,2-3.4,2c-2.8,0-4.6-2.1-4.6-4.9
                    c0-2.3,1.4-5.1,5.2-5.1C546.3,301.7,547.3,305.6,547.3,308.9z M544.5,306.6c0-1.5-0.7-2.8-2.5-2.8s-2.7,1-2.7,3
                    c0,1.7,0.8,2.7,2.5,2.7C543.6,309.5,544.5,308.3,544.5,306.6z"/>
                <path onClick={handleClick} id="m7-w2-d10-day" data-day="10" onClick={ handleClick } className="st0" d="M504.6,347.3v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H504.6z M518.9,332.5v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w2-d11-day" data-day="11" onClick={ handleClick } className="st0" d="M495.7,377.8v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H495.7z M509.9,363.1v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w2-d12-day" data-day="12" onClick={ handleClick } className="st0" d="M482.2,408.4v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H482.2z M496.4,393.7v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w2-d13-day" data-day="13" onClick={ handleClick } className="st0" d="M474.6,439v-12.5h-4.8v-2.2H482v2.2h-4.8V439H474.6z M488.8,424.3V439h-2.5v-10.7
                    c-0.7,0.7-1.8,0.9-3,0.9c-0.2,0-0.4,0-0.6,0V427c2.4,0,3.7-0.8,4-2.7H488.8z M501.5,434.7c0,3-2.2,4.6-5.2,4.6
                ...
                <path onClick={handleClick} id="m7-w3-d14-day" data-day="14" onClick={ handleClick } className="st0" d="M468.5,469.6v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H468.5z M482.7,454.9v14.8h-2.5v-10.7
                    ...
                    H491.2z"/>
                <path onClick={handleClick} id="m7-w3-d15-day" data-day="15" onClick={ handleClick } className="st0" d="M465,500.2v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H465z M479.2,485.5v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w3-d16-day" data-day="16" onClick={ handleClick } className="st0" d="M462.7,530.8v-12.5h-4.8V516h12.2v2.2h-4.8v12.5H462.7z M476.9,516v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w3-d17-day" data-day="17" onClick={ handleClick } className="st0" d="M464.4,561.4v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H464.4z M478.7,546.6v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w3-d18-day" data-day="18" onClick={ handleClick } className="st0" d="M464.5,592v-12.5h-4.8v-2.2h12.2v2.2h-4.8V592H464.5z M478.7,577.2V592h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w3-d19-day" data-day="19" onClick={ handleClick } className="st0" d="M468,622.6V610h-4.8v-2.2h12.2v2.2h-4.8v12.5H468z M482.2,607.8v14.8h-2.5v-10.7
                ...
                <path onClick={handleClick} id="m7-w3-d20-day" data-day="20" onClick={ handleClick } className="st0" d="M469.7,653.2v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H469.7z M488.2,651v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H488.2z M490.1,645.8c0-4.5,1.8-7.6,5.6-7.6s5.6,3.2,5.6,7.6
                    c0,4.5-1.8,7.6-5.6,7.6C492,653.4,490.1,650.8,490.1,645.8z M497.6,650.5c0.7-0.9,0.9-2.5,0.9-4.7c0-3.6-0.5-5.5-2.8-5.5
                    c-1,0-1.7,0.4-2.1,1.1c-0.5,0.9-0.7,2.4-0.7,4.4c0,3.7,0.5,5.5,2.8,5.5C496.5,651.3,497.2,651,497.6,650.5z"/>
                <path onClick={handleClick} id="m7-w4-d21-day" data-day="21" onClick={ handleClick } className="st0" d="M482,683.7v-12.5h-4.8V669h12.2v2.2h-4.8v12.5H482z M500.5,681.6v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H500.5z M508,669v14.8h-2.5V673c-0.7,0.7-1.8,0.9-3,0.9
                    c-0.2,0-0.4,0-0.6,0v-2.2c2.4,0,3.7-0.8,4-2.7H508z"/>
                <path onClick={handleClick} id="m7-w4-d22-day" data-day="22" onClick={ handleClick } className="st0" d="M488,714.3v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H488z M506.5,712.1v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H506.5z M518.3,712.1v2.2H508c0.2-3.6,2-5.4,4.4-6.9
                    c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7c2.8,0,4.6,1.6,4.6,4.4
                    c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H518.3z"/>
                <path onClick={handleClick} id="m7-w4-d23-day" data-day="23" onClick={ handleClick } className="st0" d="M500.6,744.9v-12.5h-4.8v-2.2H508v2.2h-4.8v12.5H500.6z M519.1,742.7v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                ...
                <path onClick={handleClick} id="m7-w4-d24-day" data-day="24" onClick={ handleClick } className="st0" d="M515.9,775.5V763h-4.8v-2.2h12.2v2.2h-4.8v12.5H515.9z M534.4,773.3v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    ...
                    H542.2z"/>
                <path onClick={handleClick} id="m7-w4-d25-day" data-day="25" onClick={ handleClick } className="st0" d="M534.1,806.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H534.1z M552.6,803.9v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H552.6z M564.7,801.3c0,2.8-1.8,5-5.3,5c-2.9,0-5-1.7-5-4.7
                    l2.5-0.4c0,1.9,1,3,2.5,3c1.8,0,2.7-1.1,2.7-3c0-1.8-1.1-2.7-2.7-2.7c-1.1,0-1.9,0.4-2.4,1.1l-2.3-0.4l1.1-8h8.1v2.2h-6l-0.5,3.8
                    c0.6-0.6,1.5-1,2.6-1C562.4,796.4,564.7,797.9,564.7,801.3z"/>
                <path onClick={handleClick} id="m7-w4-d26-day" data-day="26" onClick={ handleClick } className="st0" d="M555.5,836.7v-12.5h-4.8v-2.2H563v2.2h-4.8v12.5H555.5z M574.1,834.5v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H574.1z M586.5,832c0,2.4-1.4,5-5.2,5c-4.4,0-5.4-3.8-5.4-7.2
                    c0-4.8,1.5-8,5.7-8c2.8,0,4.2,1.7,4.5,3.9l-2.5,0.4c-0.1-1.1-0.6-2.2-2.1-2.2c-2.5,0-3.1,2.6-3.1,5.3c0.7-1.3,2-2,3.5-2
                    C584.7,827.1,586.5,829.1,586.5,832z M583.9,831.9c0-1.7-0.8-2.7-2.5-2.7c-1.7,0-2.6,1.2-2.6,2.8c0,1.4,0.7,2.8,2.5,2.8
                    C583.1,834.8,583.9,833.9,583.9,831.9z"/>
                <path onClick={handleClick} id="m7-w4-d27-day" data-day="27" onClick={ handleClick } className="st0" d="M582.5,867.3v-12.5h-4.8v-2.2H590v2.2h-4.8v12.5H582.5z M601,865.1v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H601z M602.4,852.5h9.7v2.2c-3.2,3-5.1,7.7-5.3,12.6h-2.7
                    c0.3-4.6,2-9.2,5.3-12.6h-7.1V852.5z"/>
                <path onClick={handleClick} id="m7-w5-d28-day" data-day="28" onClick={ handleClick } className="st0" d="M611.9,897.9v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H611.9z M630.4,895.7v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H630.4z M642.9,893.6c0,3-2.3,4.5-5.3,4.5
                    c-3.3,0-5.3-1.7-5.3-4.5c0-2,0.8-3.2,2.5-3.8c-1.2-0.5-2-1.5-2-3.1c0-2.1,1.4-3.9,4.8-3.9c3.3,0,4.7,1.8,4.7,3.9
                    c0,1.5-0.8,2.5-2,3.1C642.1,890.4,642.9,891.6,642.9,893.6z M640.3,893.5c0-1.5-1-2.5-2.7-2.5c-1.6,0-2.7,0.9-2.7,2.5
                    ...
                    C636.1,884.9,635.4,885.7,635.4,887z"/>
                <path onClick={handleClick} id="m7-w5-d29-day" data-day="29" onClick={ handleClick } className="st0" d="M649.1,928.5v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H649.1z M667.6,926.3v2.2h-10.3
                    c0.2-3.6,2-5.4,4.4-6.9c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7
                    c2.8,0,4.6,1.6,4.6,4.4c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H667.6z M680,920.7c0,4.7-1.4,8-5.6,8c-2.8,0-4.3-1.7-4.6-4
                    l2.4-0.4c0.1,1.2,0.7,2.3,2.2,2.3c2,0,3-1.8,3-5.2c-0.7,1.2-1.9,2-3.4,2c-2.8,0-4.6-2.1-4.6-4.9c0-2.3,1.4-5.1,5.2-5.1
                    C679,913.5,680,917.4,680,920.7z M677.2,918.4c0-1.5-0.7-2.8-2.5-2.8s-2.7,1-2.7,3c0,1.7,0.8,2.7,2.5,2.7
                    C676.2,921.3,677.2,920.1,677.2,918.4z"/>
                <path onClick={handleClick} id="m7-w5-d30-day" data-day="30" onClick={ handleClick } className="st0" d="M694.9,959.1v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H694.9z M713.7,954.8c0,3-2.2,4.6-5.2,4.6
                    c-3.4,0-5.1-2-5.2-4.8l2.6-0.4c0,1.9,0.9,3.1,2.6,3.1c1.6,0,2.6-0.8,2.6-2.4c0-1.7-1.3-2.3-2.5-2.3h-1.4v-2.2h1.1
                    c1,0,2.2-0.5,2.2-2c0-1.3-0.7-2.1-2.1-2.1c-1.9,0-2.3,1.6-2.3,2.8l-2.7-0.4c0.1-2.8,2.1-4.5,5-4.5c2.6,0,4.7,1.4,4.7,4.1
                    c0,1.3-0.7,2.4-1.9,3C712.8,951.7,713.7,953.1,713.7,954.8z M715.5,951.7c0-4.5,1.8-7.6,5.6-7.6c3.8,0,5.6,3.2,5.6,7.6
                    c0,4.5-1.8,7.6-5.6,7.6C717.4,959.3,715.5,956.7,715.5,951.7z M723,956.4c0.7-0.9,0.9-2.5,0.9-4.7c0-3.6-0.5-5.5-2.8-5.5
                    c-1,0-1.7,0.4-2.1,1.1c-0.5,0.9-0.7,2.4-0.7,4.4c0,3.7,0.5,5.5,2.8,5.5C721.9,957.2,722.5,956.9,723,956.4z"/>
                <path onClick={handleClick} id="m7-w5-d31-day" data-day="31" onClick={ handleClick } className="st0" d="M761.9,989.6v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H761.9z M780.7,985.3c0,3-2.2,4.6-5.2,4.6
                    c-3.4,0-5.1-2-5.2-4.8l2.6-0.4c0,1.9,0.9,3.1,2.6,3.1c1.6,0,2.6-0.8,2.6-2.4c0-1.7-1.3-2.3-2.5-2.3h-1.4v-2.2h1.1
                    c1,0,2.2-0.5,2.2-2c0-1.3-0.7-2.1-2.1-2.1c-1.9,0-2.3,1.6-2.3,2.8l-2.7-0.4c0.1-2.8,2.1-4.5,5-4.5c2.6,0,4.7,1.4,4.7,4.1
                ...
                <path onClick={handleClick} id="m8-w5-d1-day" data-day="1" onClick={ handleClick } className="st0" d="M876.6,1020.2v-12.5h-4.8v-2.2h12.2v2.2h-4.8v12.5H876.6z M890.9,1005.5v14.8h-2.5v-10.7
                    c-0.7,0.7-1.8,0.9-3,0.9c-0.2,0-0.4,0-0.6,0v-2.2c2.4,0,3.7-0.8,4-2.7H890.9z"/>
                <path onClick={handleClick} id="m7-w1-d1-day" data-day="1" onClick={ handleClick } className="st0" d="M876.7,71.9V59.4h-4.8v-2.2h12.2v2.2h-4.8v12.5H876.7z M890.9,57.1v14.8h-2.5V61.2
                    c-0.7,0.7-1.8,0.9-3,0.9c-0.2,0-0.4,0-0.6,0v-2.2c2.4,0,3.7-0.8,4-2.7H890.9z"/>
            </g>
            <g onClick={handleClick} id="Veranstaltungsart">
                <g onClick={handleClick} onClick={ handleClick } id="type-kunst">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-club">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-workshop">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-konzert">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-diskurs">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-tattoo">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-radio">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="type-aktion">
            ...
            <g onClick={handleClick} id="Orte">
                <g onClick={handleClick} onClick={ handleClick } id="location-foyer">
                    <text transform="matrix(0.9995 -3.165000e-02 3.165000e-02 0.9995 945.7775 119.2661)" className="st0 st1 st2"> </text>
                    <text transform="matrix(0.9966 -8.216000e-02 8.216000e-02 0.9966 925.6234 168.2829)" className="st0 st1 st3">F</text>
                    <text transform="matrix(0.999 -4.430000e-02 4.430000e-02 0.999 937.5477 167.3021)" className="st0 st1 st2">O</text>
                    <text transform="matrix(1 -6.330000e-03 6.330000e-03 1 952.6768 166.6907)" className="st0 st1 st3">Y</text>
                ...
                <g onClick={handleClick} onClick={ handleClick } id="location-radio-box">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="location-innenhof">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="location-seeufer">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="location-clubraum">
                ...
                <g onClick={handleClick} onClick={ handleClick } id="location-shedhalle">
                    <text transform="matrix(0.6944 -0.7196 0.7196 0.6944 655.9835 250.0806)" className="st0 st1 st3"> </text>
            ...
            <g onClick={handleClick} id="Wochen">
                <path onClick={handleClick} id="m7-w2-d7-week" data-week="2" onClick={ handleClick } className="st0" d="M1333.1,255.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    ...
                    c1.6-1,3.2-1.9,3.2-3.7c0-1.4-0.7-2.3-2.1-2.3c-2.1,0-2.4,1.7-2.3,3l-2.7-0.4c0-2.3,1.3-4.7,5.1-4.7c2.8,0,4.6,1.6,4.6,4.4
                    c0,2.6-1.6,3.8-3.8,5.2c-1.6,1-3,1.8-3.3,3.2H1359.5z"/>
                <path onClick={handleClick} id="m7-w2-d8-week" data-week="2" onClick={ handleClick } className="st0" d="M1354.9,286.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w2-d9-week" data-week="2" onClick={ handleClick } className="st0" d="M1373.6,316.7l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w2-d10-week" data-week="2" onClick={ handleClick } className="st0" d="M1388.5,347.3l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w2-d11-week" data-week="2" onClick={ handleClick } className="st0" d="M1400.8,377.8l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w3-d14-week" data-week="3" onClick={ handleClick } className="st0" d="M1424.3,469.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w3-d15-week" data-week="3" onClick={ handleClick } className="st0" d="M1427.9,500.2l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w3-d16-week" data-week="3" onClick={ handleClick } className="st0" d="M1428.4,530.8l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w3-d17-week" data-week="3" onClick={ handleClick } className="st0" d="M1429.5,561.4l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w3-d18-week" data-week="3" onClick={ handleClick } className="st0" d="M1427.8,592l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w4-d21-week" data-week="4" onClick={ handleClick } className="st0" d="M1410.7,683.7l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                    ...
                    H1432.5z"/>
                <path onClick={handleClick} id="m7-w4-d22-week" data-week="4" onClick={ handleClick } className="st0" d="M1401.3,714.3l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                    ...
                    H1423z"/>
                <path onClick={handleClick} id="m7-w4-d23-week" data-week="4" onClick={ handleClick } className="st0" d="M1388.4,744.9l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                    ...
                    H1410.2z"/>
                <path onClick={handleClick} id="m7-w4-d24-week" data-week="4" onClick={ handleClick } className="st0" d="M1373.3,775.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                    ...
                    H1395z"/>
                <path onClick={handleClick} id="m7-w4-d25-week" data-week="4" onClick={ handleClick } className="st0" d="M1354.2,806.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                    ...
                    H1376z"/>
                <path onClick={handleClick} id="m7-w5-d28-week" data-week="5" onClick={ handleClick } className="st0" d="M1277.4,897.9l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w5-d29-week" data-week="5" onClick={ handleClick } className="st0" d="M1239.9,928.5l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w5-d30-week" data-week="5" onClick={ handleClick } className="st0" d="M1192.8,959.1l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w5-d31-week" data-week="5" onClick={ handleClick } className="st0" d="M1125.9,989.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w1-d1-week" data-week="1" onClick={ handleClick } className="st0" d="M1026.8,72l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w1-d2-week" data-week="1" onClick={ handleClick } className="st0" d="M1129.1,102.4l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m7-w1-d3-week" data-week="1" onClick={ handleClick } className="st0" d="M1194.4,133l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    ...
                    c-0.2,0-0.4,0-0.6,0V121c2.4,0,3.7-0.8,4-2.7H1216.6z"/>
                <path onClick={handleClick} id="m7-w1-d4-week" data-week="1" onClick={ handleClick } className="st0" d="M1240.1,163.6l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
                ...
                <path onClick={handleClick} id="m8-w5-d1-week" data-week="5" onClick={ handleClick } className="st0" d="M1028.6,1020.2l-3.6-14.8h2.8l1.7,8.1c0.4,2.1,0.5,2.5,0.7,3.7h0c0.3-1.2,0.6-2.5,0.9-3.7
                    l2.1-8.1h2.7l2.1,8.1c0.4,1.4,0.6,2.5,0.8,3.7h0c0.2-1.2,0.4-2.3,0.7-3.7l1.6-8.1h2.8l-3.6,14.8h-2.8l-2.1-8
            ...
            <path onClick={handleClick} id="m7-w1-d1-event-1" onClick={ handleClick } className="st0" d="M481.1,71.9L476,57.1h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d1-event-2" onClick={ handleClick } className="st0" d="M1195.8,71.9l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d2-event-2" onClick={ handleClick } className="st0" d="M1258,102.5l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d3-event-2" onClick={ handleClick } className="st0" d="M1306.4,133.1l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d4-event-2" onClick={ handleClick } className="st0" d="M1343.3,163.7l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                v12.5H1581.6z"/>
            <path onClick={handleClick} id="m7-w2-d7-event-2" onClick={ handleClick } className="st0" d="M1424,255.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H1662.3z"/>
            <path onClick={handleClick} id="m7-w2-d8-event-2" onClick={ handleClick } className="st0" d="M1445.3,286l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d9-event-2" onClick={ handleClick } className="st0" d="M1461.2,316.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                v12.5H1699.5z"/>
            <path onClick={handleClick} id="m7-w2-d10-event-2" onClick={ handleClick } className="st0" d="M1469.7,347.2l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d11-event-2" onClick={ handleClick } className="st0" d="M1483.2,377.8L1478,363h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H1721.5z"/>
            <path onClick={handleClick} id="m7-w5-d28-event-2" onClick={ handleClick } className="st0" d="M1372.1,897.9l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H1610.3z"/>
            <path onClick={handleClick} id="m7-w5-d29-event-2" onClick={ handleClick } className="st0" d="M1342.9,928.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                v12.5H1581.2z"/>
            <path onClick={handleClick} id="m7-w5-d30-event-2" onClick={ handleClick } className="st0" d="M1306.7,959l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w5-d31-event-2" onClick={ handleClick } className="st0" d="M1258,989.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m8-w5-d1-event-2" onClick={ handleClick } className="st0" d="M1195.8,1018.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d2-event-1" onClick={ handleClick } className="st0" d="M416.7,102.5l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d3-event-1" onClick={ handleClick } className="st0" d="M369.4,133.1l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w1-d4-event-1" onClick={ handleClick } className="st0" d="M335.1,163.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d7-event-1" onClick={ handleClick } className="st0" d="M257.4,255.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d8-event-1" onClick={ handleClick } className="st0" d="M233.5,286l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d9-event-1" onClick={ handleClick } className="st0" d="M217.7,316.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d10-event-1" onClick={ handleClick } className="st0" d="M203.3,347.2l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w2-d11-event-1" onClick={ handleClick } className="st0" d="M194.4,377.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d14-event-1" onClick={ handleClick } className="st0" d="M172.2,469.5l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d15-event-1" onClick={ handleClick } className="st0" d="M167,500.1l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d16-event-1" onClick={ handleClick } className="st0" d="M164.7,530.7l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d17-event-1" onClick={ handleClick } className="st0" d="M164.8,561.3l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w5-d28-event-1" onClick={ handleClick } className="st0" d="M303,897.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w5-d29-event-1" onClick={ handleClick } className="st0" d="M333,928.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w5-d30-event-1" onClick={ handleClick } className="st0" d="M369.4,959l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w5-d31-event-1" onClick={ handleClick } className="st0" d="M416.3,989.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m8-w5-d1-event-1" onClick={ handleClick } className="st0" d="M480.6,1020.2l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H718.9z"/>
            <path onClick={handleClick} id="m7-w4-d21-event-2" onClick={ handleClick } className="st0" d="M1501,683.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d22-event-2" onClick={ handleClick } className="st0" d="M1490.4,714.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d23-event-2" onClick={ handleClick } className="st0" d="M1477.6,745l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H1715.9z"/>
            <path onClick={handleClick} id="m7-w4-d24-event-2" onClick={ handleClick } className="st0" d="M1462.5,775.5l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d25-event-2" onClick={ handleClick } className="st0" d="M1445.6,806.1l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                v12.5H1683.8z"/>
            <path onClick={handleClick} id="m7-w3-d14-event-2" onClick={ handleClick } className="st0" d="M1507.9,469.6l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                v12.5H1746.2z"/>
            <path onClick={handleClick} id="m7-w3-d15-event-2" onClick={ handleClick } className="st0" d="M1513.3,500.2l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d16-event-2" onClick={ handleClick } className="st0" d="M1515.4,530.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d17-event-2" onClick={ handleClick } className="st0" d="M1514.5,561.4l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
                ...
                H1752.8z"/>
            <path onClick={handleClick} id="m7-w3-d18-event-2" onClick={ handleClick } className="st0" d="M1512.2,592l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d21-event-1" onClick={ handleClick } className="st0" d="M179.8,683.8l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d22-event-1" onClick={ handleClick } className="st0" d="M190.2,714.3l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d23-event-1" onClick={ handleClick } className="st0" d="M203.3,744.2l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d24-event-1" onClick={ handleClick } className="st0" d="M219.5,775.5l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w4-d25-event-1" onClick={ handleClick } className="st0" d="M240.3,806.1l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
            ...
            <path onClick={handleClick} id="m7-w3-d18-event-1" onClick={ handleClick } className="st0" d="M167.9,592l-5.2-14.8h2.8l2.5,7.9c0.7,2.2,1.1,3.6,1.3,4.2h0c0.1-0.5,0.6-2,1.3-4.2
